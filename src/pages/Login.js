...
import { emailLogin, PASSWORD, passwordLogin } from '../actions';
  ...
  return (
    <div className="loginDiv">
      ...
      <input onChange={ (e) => {
        ...
        type="text" data-testid="email-input" placeholder="E-mail" />
      <br />
      ...
      <input onChange={ (e) => {
        ...
        type="password" data-testid="password-input" placeholder="Password" />
      <br />
      ...
      <br />
      { (localState.emailValid) ? <span> </span> : <span>Digite um e-mail válido.</span> }
      <br />
      { (localState.passwordValid) ? <span> </span> : <span>Digite um password válido.</span> }
    </div>
  );
}
